...
export default function ExclusiveFeaturesCard({ userPercentile, onPress }: ExclusiveFeaturesCardProps) {
  const { currentTheme } = useTheme();
  const isUnlocked = userPercentile >= 75;
  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.7} style={styles.container}>
      ...
      >
        ...
        <View style={[
          styles.overlay,
          { backgroundColor: isUnlocked ? 'rgba(0, 0, 0, 0.5)' : 'rgba(0, 0, 0, 0.65)' }
        ]} />
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            <View style={styles.titleSection}>
              ...
              <Text style={[
                ...
                {isUnlocked 
                  ? 'Detailed insights and exclusive content'
                  : 'Unlock at 75th percentile'
                }
              </Text>
            </View>
            ...
            <View style={styles.progressSection}>
              <View style={styles.progressContainer}>
                ...
                <Text style={[
                  ...
                  {userPercentile}th / 75th percentile
                </Text>
              </View>
            </View>
          )}
          ...
          <View style={styles.actionSection}>
            <View style={styles.actionButton}>
              <Ionicons 
                name={isUnlocked ? "analytics" : "arrow-forward"} 
                size={16} 
                color="white" 
              />
              <Text style={[
                ...
                {isUnlocked ? 'View Analytics' : 'Learn More'}
              </Text>
            </View>
          </View>
        </View>
