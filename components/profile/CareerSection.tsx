...
const styles = StyleSheet.create({
  ...
  newBadgeText: { fontSize: typeScale.micro, fontWeight: '700' },
  ...
  percentile: { fontSize: typeScale.hero, fontWeight: '800', lineHeight: 40, letterSpacing: -0.5 },
  heroStatLabel: { fontSize: typeScale.meta, opacity: 0.55, marginTop: 2 },
  heroBar: { marginTop: 10 },
  toNext: { fontSize: typeScale.caption, opacity: 0.55, marginTop: 6 },
  ...
  statUnit: { fontSize: typeScale.micro, fontWeight: '600', opacity: 0.6 },
  statLabel: { fontSize: typeScale.micro, opacity: 0.5, marginTop: 2 },

  consistency: { gap: 8 },
  consistencyHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline' },
  consistencyLabel: { fontSize: typeScale.micro, fontWeight: '700', letterSpacing: 1, opacity: 0.45 },
  consistencyMeta: { fontSize: typeScale.micro, opacity: 0.5 },
  ...
  nextBody: { flex: 1 },
  nextLabel: { fontSize: typeScale.caption, fontWeight: '600', marginBottom: 5 },
  nextBackText: { flex: 1, fontSize: typeScale.caption, opacity: 0.7, lineHeight: 16 },
  nextBackPct: { fontSize: 14, fontWeight: '700' },
  nextTrack: { height: 5, borderRadius: 3, overflow: 'hidden' },
  nextFill: { height: 5, borderRadius: 3 },
  nextCount: { fontSize: typeScale.caption, fontWeight: '700', opacity: 0.6 },
  ...
  achLabel: { fontSize: typeScale.micro, fontWeight: '700', letterSpacing: 1, opacity: 0.5 },
  achTopRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  achNewPill: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 8 },
  achNewPillText: { fontSize: typeScale.micro, fontWeight: '800', letterSpacing: 0.3 },
